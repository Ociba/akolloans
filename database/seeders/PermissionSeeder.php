...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            "Can delete district","Can view Account Settings","Can view Users","Can add staff member","Can view User Option","Can delete User","Can view Permissions","Can view Front Pages"];
