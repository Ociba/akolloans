    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="item_wrapper">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('front/images/courses/courses_5.jpg')}}" alt="" class="img-fluid"></a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="item_wrapper">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('front/images/courses/courses_6.jpg')}}" alt="" class="img-fluid"></a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="item_wrapper">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('front/images/courses/courses_4.jpg')}}" alt="" class="img-fluid"></a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="item_wrapper">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('front/images/courses/courses_3.jpg')}}" alt="" class="img-fluid"></a>
                    </div>
                    <h3><a href="#" title="">Magazine Design Start to Finish The Cover</a></h3> 
                </div>
                <div class="blog_title">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="item_wrapper">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('front/images/courses/courses_1.jpg')}}" alt="" class="img-fluid"></a>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div class="item_wrapper">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('front/images/courses/courses_2.jpg')}}" alt="" class="img-fluid"></a>
                    </div>
                    <h3><a href="#" title="">How to Become Master In CSS within qa Week.</a></h3> 
                </div>
                <div class="blog_title">
