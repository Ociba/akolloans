        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-7 ml-auto p-0">
            <div class="shep_banner_wrapper">
                <div class="step_single_banner">
                    <img src="{{ asset('front/images/features/features_2_1.jpg')}}" alt="" class="img-fluid">
                    <img src="{{ asset('front/images/features/features_2_2.jpg')}}" alt="" class="img-fluid">
                </div>
                <div class="step_single_banner">
                    <img src="{{ asset('front/images/features/features_2_3.jpg')}}" alt="" class="img-fluid">
                </div>
                </div>
        </div>
    </div>
