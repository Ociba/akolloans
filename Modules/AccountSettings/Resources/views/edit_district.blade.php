                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                              ...
                              <div class="col-xl-12 col-lg-12 col-xs-12 col-sm-12 col-md-12">
                                 ...
                                 <div class="card">
                                   <div class="card-body">
                                   @foreach($edit_district as $district)
                                   <form action="/accountsettings/update-district/{{$district->id}}" method="get">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="floating-label" for="Name">district</label>
                                                    <input type="text" class="form-control" id="district" name="district" value="{{$district->district}}" required>
                                                </div>
                                            </div>
