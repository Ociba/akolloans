                        ...
                        <div class="row">
                              ...
                              <div class="col-xl-12 col-lg-12 col-xs-12 col-sm-12 col-md-12">
                                 ...
                                 <div class="card">
                                   ...
                                   <form action="/front/save-reply/{{$comment->id}}" method="get">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="floating-label" for="reply">Reply</label>
                                                    <input type="text" class="form-control" id="reply" name="reply" value="{{$comment->reply}}" required>
                                                </div>
                                            </div>
